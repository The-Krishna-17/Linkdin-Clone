...
const Notification = () => {
  return (
    <>
      ...
      {/* the whole content that is going to display at md & lg screen screen  */}
      <div className="md:grid grid-cols-3 lg:grid-cols-7 md:p-6 md:gap-8 lg:px-16">
        {/* content that is going to display at left on md screen  */}
        <aside className=" hidden md:block col-span-1 lg:col-span-2">
          <div className="bg-white p-4 rounded-xl border border-slate-300">
            <div className="relative w-full h-auto">
              ...
              <img
                src={pp}
                alt=""
                class="w-16 h-16 rounded-full object-cover absolute top-5 border-2 border-white"
              />
            </div>
        ...
        <div className="md:col-span-3">
          <div className="flex justify-start gap-4 bg-white p-4 mt-3 md:mt-0 items-center font-semibold border border-slate-300 md:rounded-xl">
            <button className="border border-slate-300 p-1 rounded-full w-14">
              All
            </button>
            <button className="border border-slate-300 p-1 rounded-full w-16">
              Jobs
            </button>
            <button className="border border-slate-300 p-1 rounded-full w-24">
              My posts
            </button>
            <button className="border border-slate-300 p-1 rounded-full w-24">
              Mentions
          ...
          <div className="bg-white my-3 p-3 border border-slate-300 md:rounded-xl">
            <div className="flex gap-4 p-2">
              ...
              <p className="text-sm">
                Clock b Business Innovations is an institution that works as a
                partner of entrepreneurs and investors to
              </p>
            ...
            <div className="flex gap-4 p-2">
              ...
              <p className="text-sm">
                Tuesday <span>Wrap-Up</span>: Sailing the leader's ship; Buldak
                ramen's viral success; and more.
              </p>
              <div className="flex flex-col items-center text-sm gap-2">
                <p>2h</p>
                <FaEllipsisH />
            ...
            <div className="flex gap-4 p-2">
              <img src={no1} alt="" className="w-12" />
              <p className="text-sm">
                Akhir tahun adalah waktu yang baik untuk kita melakukan
                refleksi. Untuk tetap semangat di tahun
              </p>
            ...
            <div className="flex gap-4 p-2">
              ...
              <p className="text-sm">
                Prestasi apa saja yang paling kamu banggakan di tahun 2024? Yuk,
                saling berbagi di bagian komentar..
              </p>
              <div className="flex flex-col items-center ext-sm gap-2">
                <p>8h</p>
                <FaEllipsisH />
            ...
            <div className="p-4">
              <button className="w-full border-2 border-slate-500 font-semibold text-slate-600 rounded-full mb-4 py-1">
                Show more Results
              </button>
            </div>
          </div>
        </div>
        {/* content that is going to display at the right side of the screen in lg devices */}
