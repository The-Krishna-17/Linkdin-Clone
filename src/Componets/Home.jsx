      ...
      <div className="md:p-8 lg:px-12 grid md:grid-cols-3 lg:grid-cols-[1.7fr,2.5fr,1fr,2fr] gap-6 ">
        ...
        <aside className=" hidden md:block md:col-span-1">
          ...
          <div className="relative w-full h-auto">
            ...
            <div className="flex flex-col items-center mt-[4.5rem]">
              ...
              <p className="text-xs text-slate-700">
                Attended Asia Pacific University of Technology and Innovation
                (APU / APIIT)
              </p>
            </div>
            ...
            <div>
              ...
              <p className="flex items-center text-sm gap-3 pl-3 font-semibold">
                <div className="h-4 w-4 bg-[#E7A33E] rounded-sm shadow-lg shadow-[#C37D16]"></div>
                Try Premium for $0
              </p>
            </div>
            <hr className="my-4 border-gray-300" />
          ...
          <div className="bg-white mt-4 p-4 rounded-xl border border-slate-300">
            ...
            <p className="text-blue-700 text-xs font-semibold flex items-center justify-between">
              Events <IoMdAdd className="text-lg text-stone-900" />
            </p>
            <hr className="my-4 border-gray-300" />
        ...
        <div className="md:col-span-2 ">
          ...
          <header className="bg-white border border-slate-300 md:rounded-xl">
            ...
            <div className="flex items-center p-4 gap-4">
              ...
              <input
                ...
                className="border border-slate-400 h-12 w-full rounded-3xl p-4 placeholder-slate-700"
              />
            </div>
          ...
          {datas.map((data) => (
            <div
              key={data.id}
              className="bg-white mt-3 p-5 border border-slate-300s md:rounded-xl"
            >
                ...
                <div className="py-2">
                  ...
                  <div className="flex justify-between mt-1">
                    ...
                    <p className="font-semibold text-slate-600">
                      {data.comments} comments . {data.repost} reposts
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex justify-center w-full my-8">
            <button className="w-[90%] border-2 border-slate-700 p-1 rounded-full font-semibold text-slate-700">
              Show more feed upadates
            </button>
          </div>
            ...
            {addToFeed.map((data) => (
              <div key={data.id} className="flex gap-3 py-1 px-3 ">
                ...
                <div>
                  ...
                  <button className="border border-slate-800 px-3 py-1 rounded-full my-2 font-semibold text-slate-600">
                    + Follow
                  </button>
                </div>
              </div>
            ))}
            <p className="flex items-center px-3 pb-3 gap-2 text-sm font-semibold text-slate-700">
              View all recommendations <FaArrowRightLong />
            </p>
          </div>
          {/* footer image  */}
          ...
          <div className="flex flex-col gap-3 mb-4 lg:hidden">
            ...
            <div className="flex gap-2 items-center justify-center mb-3">
              <p className="font-bold text-blue-600 flex items-center text-sm">
                Linked
                <img src={footerLogo} alt="logo" className="h-4" />{" "}
              </p>
        ...
        <aside className="hidden lg:block">
          ...
          <div className="bg-white p-4 space-y-4 rounded-xl">
            <h2 className="flex items-center justify-between font-semibold">
              Add to your feed <BsExclamationSquareFill />
            </h2>
            <div className="flex gap-2">
              ...
              <div>
                <h2 className="font-semibold text-sm">
                  InterSathi - Internships in Nepal
                </h2>
                <p className="text-xs text-slate-700">
                  Company . Human Resources Services
                </p>
                <button className="flex items-center gap-2 font-bold border border-slate-700 py-1 px-3 rounded-full shadow-sm shadow-slate-400 mt-3">
                  <FaPlus />
                  Follow
                </button>
              </div>
            ...
            <div className="flex gap-1">
              ...
              <div>
                ...
                <p className="text-xs text-slate-700">
                  Contetnt Creator || 279K+ Subscribers ||
                </p>
            ...
            <button className="flex items-center gap-4 text-slate-600 font-semibold">
              View all recomendations <FaArrowRightLong />
            </button>
          </div>
          {/* footer image  */}
